...
namespace Library.Combate
{
    ...
    public class Menu
    {
        ...
        {
            return batallaActual.RestringirTipo(tipo);
        }
        public string RestringirPokemon(string pokemon)
        {
            return batallaActual.RestringirPokemon(pokemon);
        }
        public string RestringirItem(string item)
        {
            return batallaActual.RestringirItem(item);
        }

        public string MostrarRestricciones()
        {
            return batallaActual.restricciones;
        }
    }
}